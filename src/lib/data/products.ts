    ...
    .fetch<{
      ...
      query: {
        ...
        fields:
          ...
          '*seller.reviews,*seller.reviews.customer,*seller.reviews.seller,*seller.products.variants,*attribute_values,*attribute_values.attribute,*tags,*images,+metadata',
        ...queryParams
      },
      headers,
