...
export function SkipLink({ label }: SkipLinkProps) {
  return (
    <a
      href="#main-content"
      className="sr-only focus-visible:not-sr-only focus-visible:fixed focus-visible:left-4 focus-visible:top-4 focus-visible:z-[9999] focus-visible:rounded-sm focus-visible:bg-action focus-visible:px-4 focus-visible:py-2 focus-visible:text-action-on-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--accent,#A89279)]"
    >
      {label}
    </a>
  );
