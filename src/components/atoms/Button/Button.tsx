...
export function Button({
  ...
  const baseClasses =
    'text-md button-text rounded-sm min-h-[44px] disabled:bg-disabled disabled:text-disabled dark:bg-action-tertiary dark:hover:bg-action-tertiary-hover dark:active:bg-action-tertiary-pressed dark:disabled:bg-disabled';
