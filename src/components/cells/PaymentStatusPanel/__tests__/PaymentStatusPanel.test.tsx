...
describe('PaymentStatusPanel', () => {
  ...
  // F24 review fix + R18 second-pass note: the *real* "is the timestamp
  // actually formatted" assertion lives in formatTimestamp.test.ts (which
  // tests the pure helper directly). This smoke check stays here as a
  // safety net for "did anyone wire the panel to bypass the formatter."
