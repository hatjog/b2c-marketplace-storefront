/**
 * Story v1.8.0-7-5: W5-05 Product 404 variant.
 *
 * App Router not-found boundary for /[locale]/products/[handle].
 * Renders when fetchProductForDetailPage returns null (product not found).
 *
    ...
    >
      ...
      >
        ...
        >
          <Link
            href="/"
            data-testid="product-not-found-cta-home"
            style={{
              display: 'inline-flex',
              alignItems: 'center',
              justifyContent: 'center',
          ...
          <Link
            href="/?search=1"
            data-testid="product-not-found-cta-search"
            style={{
              display: 'inline-flex',
              alignItems: 'center',
              justifyContent: 'center',
