  ...
  return (
    <BlogLayout
      ...
      content={
        ...
        >
          <div
            className="flex flex-col gap-3 rounded-[28px] border border-[rgba(144,112,50,0.14)] bg-white p-5 md:flex-row md:items-center md:justify-between"
            ...
            >
              {data.items.map(item => (
                <LocalizedClientLink
                  ...
                  className="group flex min-h-[280px] flex-col overflow-hidden rounded-[28px] border border-[rgba(144,112,50,0.14)] bg-white shadow-[0_16px_40px_rgba(90,67,28,0.08)] motion-safe:transition-transform motion-safe:duration-300 motion-safe:hover:-translate-y-1 motion-reduce:transform-none"
          ...
          <div className="grid gap-5 md:grid-cols-3">
            {data.related.map(collection => (
              <LocalizedClientLink
                ...
                className="rounded-[28px] border border-[rgba(144,112,50,0.14)] bg-white p-5 shadow-[0_16px_40px_rgba(90,67,28,0.08)]"
