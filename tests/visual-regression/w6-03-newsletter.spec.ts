// Visual regression spec — W6-03 newsletter slot (Story 3.1 Wave 6 chrome full impl).
// Variants × 3 breakpoints (375/768/1280) × 4 locales (pl/en/ua/de).
// Run: playwright test tests/visual-regression/w6-03-newsletter.spec.ts --update-snapshots
...
defineWave6Spec('w6-03-newsletter');
