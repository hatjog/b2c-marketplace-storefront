// Visual regression spec — W6-09 search overlay (Story 3.1 Wave 6 chrome full impl).
// Variants × 3 breakpoints (375/768/1280) × 4 locales (pl/en/ua/de).
// Run: playwright test tests/visual-regression/w6-09-search-overlay.spec.ts --update-snapshots
...
defineWave6Spec('w6-09-search-overlay');
